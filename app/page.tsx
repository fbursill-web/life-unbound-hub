...
const [availDaysState, setAvailDaysState] = useState<Record<string, any>>({
...
const formatStr = ${startPoint.toLocaleDateString('en-AU', { day: 'numeric', month: 'short' })} to ${endPoint.toLocaleDateString('en-AU', { day: 'numeric', month: 'short' })};
...
const updateAvailabilityMode = (day: string, mode: string) => {
...
const updateAvailabilityTimes = (day: string, field: string, val: string) => {
const updated = { ...availDaysState };
              ...
              <div className="bg-white border border-slate-200 p-5 rounded-xl shadow-sm space-y-4">
                ...
                <form onSubmit={handleCreateShift} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 pt-1">
                  ...
                  <div className="lg:col-span-4">
                    <input type="text" placeholder="Manager Directives string data..." value={shiftDirectives} onChange={(e) => setShiftDirectives(e.target.value)} className="w-full bg-white border border-gray-200 rounded-lg p-2 text-xs text-gray-800 outline-none" />
                  </div>
